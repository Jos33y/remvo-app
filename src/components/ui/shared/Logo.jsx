...
import styles from '@styles/ui/shared/logo.module.css';
 ...
 *
 * SVG viewBox: 0 0 40 40. The vault polygons occupy y=6 to y=32.
 * A 40x40 viewBox gives 8 units of breathing room top and bottom,
 * with geometric centre at y=20 and visual centre at y=19 | a 1-unit
 * offset negligible at render size. Earlier revisions used 0 0 40 48
 * which left 16 units of empty space at the bottom and pushed the
 * vault's visual centre above the bounding box centre, breaking
 * optical alignment with adjacent text across every header.
 */
